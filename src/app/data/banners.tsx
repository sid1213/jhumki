import { Images, SwiperComponentProps, SwiperSlideCustomProps } from "../types/types";
...
export const bannersData: Images[] = [
  ...
  { src: ['https://cdn.picpil.com/fit-in/1800x600/banners/2023/11/326/Avantika_Seasons_New_Styles_Desktop-2023.jpg','https://cdn.picpil.com/fit-in/1800x600/banners/2023/11/326/Avantika_Seasons_New_Styles_Desktop-2023.jpg']}
];
